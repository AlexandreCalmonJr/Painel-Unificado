...
/// Classe para armazenar dados de localiza��o mapeados
class LocationData {
  LocationData({
...
class LocationMapperService {
  ...
  /// Mapeia a localiza��o de um dispositivo baseado em BSSID ou IP
  static LocationData mapLocation({
    ...
    // 3?? Construir a string de localiza��o
  ...
  /// Constr�i a string de localiza��o formatada (vers�o est�tica)
