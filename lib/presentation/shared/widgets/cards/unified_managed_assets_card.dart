...
class UnifiedManagedAssetsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isDark = themeController.state.isDarkMode;
                ...
                columns:
                    columns.map((col) {
                      ...
                      if (col.width != null) {
                        ...
                        if (col.dataKey == 'assetName' ||
                            col.dataKey == 'hostname') {
                          flex = 2;
                        }
                        if (col.dataKey == 'serialNumber') flex = 2;
                        if (col.dataKey == 'status') flex = 1;
                      }
                      ...
                      return DataTableColumn<ManagedAsset>(
                        ...
                        builder: (asset) {
                          ...
                          if (dataKey == 'sector_floor') {
                            return _buildSectorFloorCell(assetData, textColor);
                          }
