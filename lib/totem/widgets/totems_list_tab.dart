...
/// Similar ao ManagedDevicesCard, mas específico para Totems.
class ManagedTotemsCard extends StatelessWidget {
  ...
  /// Gera e descarrega um ficheiro CSV com os dados dos totens.
  Future<void> _downloadTotemsCsv(
    ...
    final rows = totemsToExport.map((totem) {
      return [
        ...
        totem.serialNumber,
        totem.model,
        formatDateTime(parseLastSeen(totem.lastSeen)),
        totem.zebraStatus,
  ...
  Widget build(BuildContext context) {
    // Ordena os totens por nome de anfitrião para uma visualização consistente
